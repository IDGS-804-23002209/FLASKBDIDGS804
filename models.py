...
class Inscripcion(db.Model):
    ...
    alumno = db.relationship('Alumno', backref=db.backref('inscripciones_alumno', overlaps="alumnos,cursos"))
    curso = db.relationship('Curso', backref=db.backref('inscripciones_curso', overlaps="alumnos,cursos"))
